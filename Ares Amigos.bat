@echo off
taskkill /f /im CARMELIX.exe
taskkill /f /im Spam.exe
...
if not exist "%userprofile%\desktop\Ended_work.txt" echo Bene, il computer è libero dal malefico Carmelix.exe >> Ended_work.txt
